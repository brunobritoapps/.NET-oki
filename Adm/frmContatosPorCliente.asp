...
'------------------------	
	...
	Sub GetContatos()
		...
		sSql = "SELECT " & _ 
						...
						"ON B.[Grupos_idGrupos] = D.[idGrupos]"
...
'			response.end    
        Else 
            if len(trim(Request.Form("hidden_idcliente"))) = 0 Then
                sSql = sSql & " where A.Clientes_idCLientes = " & Request.QueryString("idcliente")
            else
                sSql = sSql & " where A.Clientes_idCLientes = " & Request.Form("hidden_idcliente")
            End If
		End If					
		...
		With Response
			...
			For i = (intProdsPorPag * (intPag - 1)) to intUltima
					...
					If i Mod 2 = 0 Then
						.Write "<tr>"
						.Write "<td class='classColorRelPar'><input type='radio' name='radioIntIdContato' value='"&arrContatos(0,i)&"' onClick=window.location.href='frmContatosPorCliente.asp?idcliente="&Request.QueryString("idcliente")&"&IDContato="&arrContatos(0,i)&"' "&sSelected&"/></td>"
					...
					Else	
						.Write "<tr>"
						.Write "<td class='classColorRelImpar'><input type='radio' name='radioIntIdContato' value='"&arrContatos(0,i)&"' onClick=window.location.href='frmContatosPorCliente.asp?idcliente="&Request.QueryString("idcliente")&"&IDContato="&arrContatos(0,i)&"' "&sSelected&"/></td>"
	...
	Sub SubmitForm()
		...
		If Request.ServerVariables("HTTP_METHOD") = "POST" Then
            ...
            if len(trim(Response.QueryString("idcliente"))) = 0 Then
                response.write "<script>javascript:history.back(2);</script>"
            End if
	...
	Function GetWhereFindContato()
        ...
        if len(trim(sSqlWhere)) > 0 Then
            sSqlWhere = sSqlWhere & " A.Clientes_idClientes = " & Request.QueryString("idcliente")
        Else
            sSqlWhere = sSqlWhere & " where A.Clientes_idClientes = " & Request.QueryString("idcliente")
        End if
...
<html>
<head>
<script src="js/frmContatosPorClienteAdm.js" language="javascript"></script>
...
<div id="container">
	...
	<div id="conteudo">
		...
		<form action="frmContatosPorCliente.asp" name="frmContatosPorCliente" method="POST">
            ...
            <input type="hidden" name="hidden_idcliente" value="<%=Request.QueryString("idcliente")%>"/>
			<tr>
				...
				<td id="conteudo">
						<table cellpadding="3" cellspacing="4" width="100%">
							...
							<tr>
								<td colspan="3" align="right"><a class="linkoperacional" href='javascript:history.back(1)'>Voltar</a></td>
                                
							</tr>
							<tr>
								<td valign="top" colspan="2">
									<table cellpadding="2" cellspacing="2" width="100%" id="tableContatosAdm" align="center">
										<tr>
										...
										<tr>
											...
											<td align="left" colspan="4" ><input name="txtSenhaContato" class="textreadonly" type="text" value="<%=SenhaInfo%>" size="20" maxlength="20" /></td>
										</tr>
										<tr>
