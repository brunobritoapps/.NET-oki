...
<%
	Sub GetProductBySol()
		...
		sSql = "SELECT A.[idproduto] " & _
				  ...
				  "ON A.[idproduto] = B.[IDOKI] " & _
				  "WHERE [idsolicitacao] = " & Request.QueryString("idsol")
		...
		If intProd > -1 Then
			...
			Next
		Else
			Response.Write "<tr><td colspan=""3"" class='classColorRelPar' align=""center""><b>Nenhum Produto encontrado</b></td></tr>"	
		End If				
	End Sub
%>
<html>
