		...
		<form action="frmOperacionalAdm.asp" name="frmOperacionalAdm" method="POST">
			<tr> 
              ...
              <table width="98%" border="0" align="center" cellpadding="2" cellspacing="3">
                ...
                <% If not isnull(session("IDAdministrator")) and not isempty(session("IDAdministrator")) Then %>
					<tr>
						<td id="explaintitle" align="right" colspan="3" style="padding:4px 4px 4px 4px;">
							<a href="frmoperacionaladm.asp?logoff=true" style="color: #FFFFFF;">Logoff do Sistema</a>
						</td>
					</tr>
				<% End If %>

                <tr> 
                  <td colspan="3" id="explaintitle"><div align="center">Painel de Controle da Administração - Cliente</div></td>
                </tr>
                <tr> 
