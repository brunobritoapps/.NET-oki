...
function cancelar(ID) {
	document.frmEditSolicitacaoColetaAdm.cbStatusSolColeta.value = 4;
...
function validateGetDate(dataDefault, date) {
	...
	if (parseInt(date.getFullYear()) < parseInt(dataDefault.getFullYear())) {
		...
		if (parseInt(date.getMonth()) < parseInt(dataDefault.getMonth())) {
			...
			//alert(parseInt(date.getFullYear()+date.getMonth()+date.getDate()) +' - '+ parseInt(dataDefault.getFullYear()+dataDefault.getMonth()+dataDefault.getDate()));
