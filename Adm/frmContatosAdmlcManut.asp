...
'			response.end
		...
		With Response
			...
			For i = (intProdsPorPag * (intPag - 1)) to intUltima
					...
					If i Mod 2 = 0 Then
						.Write "<tr>"
						.Write "<td class='classColorRelPar'><input type='radio' name='radioIntIdContato' value='"&arrContatos(0,i)&"' onClick=window.location.href='frmContatosAdmlc.asp?IDContato="&arrContatos(0,i)&"' "&sSelected&"/></td>"
