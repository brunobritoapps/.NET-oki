...
<script language="javascript" type="text/javascript" src="js/frmSearchTranspCliente.js"></script>
</head>
			...
			<tr> 
				<td id="conteudo">
					<div style="overflow:scroll;width:410px;height:317px;">
						<form action="frmSearchTranspCliente.asp" name="frmSearchTranspCliente" method="POST">
