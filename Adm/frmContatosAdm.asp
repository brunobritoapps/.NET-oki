...
'			response.end
		...
		With Response
			...
			For i = (intProdsPorPag * (intPag - 1)) to intUltima
					...
					If i Mod 2 = 0 Then
						.Write "<tr>"
						.Write "<td class='classColorRelPar'><input type='radio' name='radioIntIdContato' value='"&arrContatos(0,i)&"' onClick=window.location.href='frmContatosAdm.asp?IDContato="&arrContatos(0,i)&"' "&sSelected&"/></td>"
						.Write "<td class='classColorRelPar'>"&arrContatos(1,i)&"</td>"
						.Write "<td class='classColorRelPar'>"&arrContatos(2,i)&"</td>"
					...
					Else	
						.Write "<tr>"
						.Write "<td class='classColorRelImpar'><input type='radio' name='radioIntIdContato' value='"&arrContatos(0,i)&"' onClick=window.location.href='frmContatosAdm.asp?IDContato="&arrContatos(0,i)&"' "&sSelected&"/></td>"
						.Write "<td class='classColorRelImpar'>"&arrContatos(1,i)&"</td>"
						.Write "<td class='classColorRelImpar'>"&arrContatos(2,i)&"</td>"
						.Write "<td class='classColorRelImpar'>"&arrContatos(3,i)&"</td>"
...
<div id="container">
	...
	<div id="conteudo">
		...
		<form action="frmContatosAdm.asp" name="frmContatosAdm" method="POST">
			...
			<tr>
				...
				<td id="conteudo">
						<table cellpadding="3" cellspacing="4" width="100%">
							<tr>
								<td colspan="3" id="explaintitle" align="center">Cadastro / Alteração de Contatos</td>
							</tr>
							<tr>
								...
								<td valign="top">
									<table cellpadding="2" cellspacing="2" width="100%" id="tableContatosAdm" align="center">
										<tr>
											...
											<td align="left" ><input name="txtNomeContato" class="text" type="text" value="<%=NomeInfo%>" size="40" maxlength="40"></td>
										</tr>
										<tr>
											<td align="left" width="8%">Usuário:</td>
											<td align="left" ><input name="txtUsuarioContato" class="text" type="text" value="<%=UsuarioInfo%>" size="20" maxlength="20" /></td>
										</tr>
										<tr>
											<td align="left" width="8%">Senha:</td>
											<td align="left" ><input name="txtSenhaContato" class="text" type="password" value="<%=SenhaInfo%>" size="20" maxlength="20" /></td>
										</tr>
										<tr>
											<td align="left" width="8%">Email:</td>
											<td align="left" ><input name="txtEmailContato" class="text" type="text" value="<%=EmailInfo%>" size="30" maxlength="255"></td>
										</tr>
										<tr>
										...
										<tr>
											<td>
												<%If Request.QueryString("IDContato") <> "" Then%>	
													<input name="btnEditarContato" class="btnform" type="button" value="Editar" onClick="setActionForm('UPDATE')" />
												<%Else%>	
													<input name="btnSalvarContato" class="btnform" type="button" value="Salvar" onClick="setActionForm('INSERT')" />
												<%End If%>
											</td>
											<td>
												<input name="btnLimpar" class="btnform" type="reset" value="Limpar" />
											</td>
										</tr>
										<% End If %>
									</table>
							...
							<tr id="findcontato" valign="baseline">
								<td align="left" valign="baseline" colspan="2">
									Busca: <input type="text" class="text" name="txtFindContato" value="" size="90" />
									&nbsp;&nbsp;&nbsp;
									Por:
