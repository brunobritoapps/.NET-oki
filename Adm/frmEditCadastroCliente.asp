								...
								<table cellpadding="1" cellspacing="1" width="100%" id="editTableCadClienteAlpha">
									<tr>
										<td colspan="2" align="center">
											Pessoa Física <input type="radio" name="radioPessoa" disabled="disabled" value="0" <% If CInt(TipoPessoa) = 0 Then %>checked<% End If %> onClick="tipopessoa()"/>
											Pessoa Jurídica <input type="radio" name="radioPessoa" disabled="disabled" value="1" <% If CInt(TipoPessoa) = 1 Then %>checked<% End If %> onClick="tipopessoa()" />
										</td>
									</tr>
									<tr id="razaosocial">
										<td align="right" width="33%">Razão Social:</td>
									...
									<tr id="inscestadual">
										<td align="right" width="33%">Inscrição Estadual:</td>
									...
									<tr>
										<td width="35%" align="right"><label id="numidtransportadora">Cód. Consolidador: </label></td>
										<td>
									...
									<tr>
										<td colspan="2" align="center"><b>Endereço Comum</b></td>
									</tr>
									<tr>
									...
									<tr>
										<td colspan="2" align="center"><b style="color:#FF0000;">Ponto de Coleta onde foi feita a solicitação!</b></td>
									</tr>
									<tr>
