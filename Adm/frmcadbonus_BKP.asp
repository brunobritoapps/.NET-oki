      ...
      <form action="frmcadbonus.asp" name="frmcadbonus" method="POST">
        <tr>
          ...
          <td id="conteudo"><table cellspacing="1" cellpadding="1" width="100%" border=0 id="tableEditSolicitacaoColetaAdm">
              <tr>
                <td colspan="3" id="explaintitle" align="center">Cadastro de Bônus</td>
              </tr>
              <tr>
              ...
              <tr>
                <td colspan="2" align="center"><fieldset style="width:700px;padding:5px 5px 5px 5px;">
                  ...
                  <div align="right">
                    <input type="button" class="btnform" name="listar" value="Listar Bônus" onClick="javascript:window.open('frmlistabonus.asp','','width=700,height=400,scrollbars=no,status=no,location=no,toolbar=no,menubar=no');" />
