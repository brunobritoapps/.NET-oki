...
function validaCnpj() {
	...
	if (document.frmCadastroClienteAdm.txtCNPJCliente.value.indexOf('/') == -1) {
		alert("Preencha corretamente o campo CNPJ barra");
		return;
	}
	if (document.frmCadastroClienteAdm.txtCNPJCliente.value.length < 18) {
		alert("Preencha corretamente o campo CNPJ menor que 18");
		return;
	}
	cnpj = cnpj.replace('/','');
	cnpj = cnpj.replace('-','');
	...
	if (resto1Dig < 2) {
		if (!(digVer1 == 0)) {
			alert("Preencha corretamente o campo CNPJ digito");
			return;
		}	
	} else {
		resto1Dig = 11 - resto1Dig;
		if (!(resto1Dig == digVer1)) {
			alert("Preencha corretamente o campo CNPJ mod11");
			return;
		}	
	}
	...
	if (resto2Dig < 2) {
		if (!(digVer2 == 0)) {
			alert("Preencha corretamente o campo CNPJ 11");
			return;
		}	
	} else {
		resto2Dig = 11 - resto2Dig;
		if (!(resto2Dig == digVer2)) {
			alert("Preencha corretamente o campo CNPJ resto");
			return;
		}	
	}
}
...
function tipopessoa() {
	...
	if (form.radioPessoa[0].checked) {
        ...
        document.getElementById('razaosocial').style.width = '100%'';
