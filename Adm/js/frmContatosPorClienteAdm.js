...
function windowLocationFind(url) {
	var find			 = true;
	var busca 			 = document.frmContatosPorCliente.txtFindContato.value;
	var por 			 = document.frmContatosPorCliente.typeFindContato.value;
	var status 			 = document.frmContatosPorCliente.cbStatusFindContato.value;
	var categoria		 = document.frmContatosPorCliente.cbCategoriasFindContato.value;
	var grupo 			 = document.frmContatosPorCliente.cbGruposCliente.value;
	//window.location.href = url + "frmContatosPorCliente.asp?find=true&search="+busca+"&changetype="+por+"&status="+status+"&categoria="+categoria+"&grupo="+grupo;
	window.location.href = "frmContatosPorCliente.asp?find=true&search="+busca+"&changetype="+por+"&status="+status+"&categoria="+categoria+"&grupo="+grupo;
}

//function checkUserContato() {
//	if ((document.frmContatosPorCliente.txtUsuarioContato.value != document.frmContatosPorCliente.hidden_usuario_info.value) && 
//		 (document.frmContatosPorCliente.txtSenhaContato.value != document.frmContatosPorCliente.hidden_senha_info.value)) {
...
//					document.frmContatosPorCliente.txtUsuarioContato.focus();
//				}
//			}
//		}
//		
//		oAjaxUserContato.open("GET", "../../ajax/frmCadCliente.asp?sub=getcheckusercontato&id=0&user="+document.frmContatosPorCliente.txtUsuarioContato.value+"&senha="+document.frmContatosPorCliente.txtSenhaContato.value, true);
...
//		}
//		
//		oAjaxUsuario.open("GET", "../../ajax/frmCadCliente.asp?sub=getcheckusuario&id=0&user="+document.frmContatosPorCliente.txtUsuarioContato.value, true);
...
function setActionForm(action) {
	var form = document.frmContatosPorCliente;
