...
<%
	...
	Sub EnviaEmailAtlas(Destino)
		...
		sql = "select " & _
                ...
                ",a.numero_solicitacao_coleta, a.qtd_cartuchos, a.observacao " & _
        ...
        if intarr > -1 then
            ...
            MsgBody = MsgBody & "<tr style='width:748px;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px;'>"
            MsgBody = MsgBody & "<td width='10%'>&nbsp;</td>"
            MsgBody = MsgBody & "<td width='07%' align='right'><font size=1 face='Verdana'>Complemento:</font></td>"
            MsgBody = MsgBody & "<td width='55%'><font size=1 face='Verdana'>"& arr(4,0) & "</font></td>"
            MsgBody = MsgBody & "<td width='10%'>&nbsp;</td>"
            MsgBody = MsgBody & "</tr>	"
            ...
            MsgBody = MsgBody & "<td width='55%'>" & arr(8,0) & "</td>"
            MsgBody = MsgBody & "<td width='10%'>&nbsp;</td>"

            MsgBody = MsgBody & "</tr>							"
            MsgBody = MsgBody & "<tr style='width:748px;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px;'>"
            MsgBody = MsgBody & "<td width='10%'>&nbsp;</td>"
            MsgBody = MsgBody & "<td width='07%' align='right'>Telefone:</td>"
            MsgBody = MsgBody & "<td width='55%'>(" & arr(9,0) & ") " & arr(10,0) & " Ramal: " & arr(12,0) & "</td>"
            MsgBody = MsgBody & "<td width='10%'>&nbsp;</td>"
            MsgBody = MsgBody & "</tr>							"
            MsgBody = MsgBody & "</tr>							"
            MsgBody = MsgBody & "<tr style='width:748px;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px;'>"
            MsgBody = MsgBody & "<td width='10%'>&nbsp;</td>"
            MsgBody = MsgBody & "<td width='07%' align='right'>Departamento:</td>"
            MsgBody = MsgBody & "<td width='55%'>" & arr(11,0) & "</td>"
            MsgBody = MsgBody & "<td width='10%'>&nbsp;</td>"
            MsgBody = MsgBody & "</tr>							"
            ...
            MsgBody = MsgBody & "<tr style='width:748px;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px;'>"
            MsgBody = MsgBody & "<td width='10%'>&nbsp;</td>"
            MsgBody = MsgBody & "<td width='07%' align='right'>Cartuchos:</td>"
            MsgBody = MsgBody & "<td width='55%'>" & arr(18,0) & "</td>"
            MsgBody = MsgBody & "<td width='10%'>&nbsp;</td>"
            MsgBody = MsgBody & "</tr>							"
            MsgBody = MsgBody & "</tr>							"
            MsgBody = MsgBody & "<tr style='width:748px;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px;'>"
            MsgBody = MsgBody & "<td width='10%'>&nbsp;</td>"
            MsgBody = MsgBody & "<td width='07%' align='right'>Observação:</td>"
            MsgBody = MsgBody & "<td width='55%'>" & arr(19,0) & "</td>"
            MsgBody = MsgBody & "<td width='10%'>&nbsp;</td>"
            MsgBody = MsgBody & "</tr>							"
