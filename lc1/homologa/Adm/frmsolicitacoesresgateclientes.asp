...
'Descrição: Inclusão do campo Data_solicitacao para que apareça no relatório
		...
		With Response	
			If intSolColeta > -1 Then
				...
				For i = (intProdsPorPag * (intPag - 1)) to intUltima
					If i Mod 2 = 0 Then
						.Write "<tr>"
						.Write "<td width='5%' align='center' class='classColorRelPar'><img class='imgexpandeinfo' src='img/buscar.gif' alt='Verificar Solicitação de Resgate' onClick=""javascript:window.open('frmeditsolicitacaoresgatecliente.asp?idsolic="&arrSolColeta(1,i)&"','','width=500,height=460,scrollbars=no,status=no,location=no,toolbar=no,menubar=no');"" ></td>"
					...
					Else
						.Write "<tr>"
						.Write "<td width='5%' align='center' class='classColorRelImpar'><img class='imgexpandeinfo' src='img/buscar.gif' alt='Verificar Solicitação de Coleta' onClick=""javascript:window.open('frmeditsolicitacaoresgatecliente.asp?idsolic="&arrSolColeta(1,i)&"','','width=500,height=460,scrollbars=no,status=no,location=no,toolbar=no,menubar=no');"" ></td>"
