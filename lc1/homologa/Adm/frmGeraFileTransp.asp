...
'					response.write "intarr: " & intarr & "<br />"
					...
					for i=0 to intarr
						if isMaster(solicitacoes(cont_sol)) then
							...
							html = html & "<div align=""left""><b>Nº de Solicitação:</b> " & arr(2,i) & "</div>"
							html = html & "<div align=""left""><b>Razão Social:</b> " & arr(5,i) & "</div>"
							html = html & "<div align=""left""><b>CNPJ:</b> " & formataCNPJ(trim(arr(12,i))) & "</div>"
							html = html & "<div align=""left""><b>Endereço:</b> " & arr(6,i) & "," & arr(7,i) & "</div>"
							...
							html = html & "<div align=""left""><b>Por favor informar nº do conhecimento e data provável de retirada.</b></div>"
							html = html & "<br /><br />"
							html = html & "</div>"
						else
							...
							"<body> " & _
								"<div id=""container"" align=""center""> " & _
									"<div id=""bottom"" style=""font-family:Verdana, Arial, Helvetica, sans-serif;font-size:10px;width:748px;""> " & _
										...
										"<br />	" & _
										"Por gentileza efetuar o agendamento da coleta, em horário comercial, no(s) " & _
										"seguinte(s) cliente(s): <br /><br />" & _
										"" &html_solicitacoes& "" & _
										"Érico Tooru Tanji<br /> " & _
										"Operações - Logística Reversa/Suprimentos<br /> " & _
...
("http://schemas.microsoft.com/cdo/configuration/smtpauthenticate") = 1
	...
	if request.servervariables("HTTP_METHOD") = "POST" then
		if geraArquivo(request.form("id")) then
			...
			response.write "<script>alert('Arquivo não pode ser gerado')</script>"
		end if
	end if
%>
<html>
			...
			<tr>
				...
				<td id="conteudo">
					<table cellpadding="1" cellspacing="1" width="100%" id="tableprodcad">
						<tr>
							<td colspan="12" id="explaintitle" align="center">Gera Arquivo Eletrônico para Transportadora</td>
						</tr>
						<tr>
