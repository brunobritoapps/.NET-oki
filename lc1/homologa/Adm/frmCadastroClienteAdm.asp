...
'			response.end()
		...
		If intClientes > -1 Then 
			...
			For i = (intProdsPorPag * (intPag - 1)) to intUltima
				If i Mod 2 = 0 Then
					Response.Write "<tr>" 				
					Response.Write "<td class='classColorRelPar' align='center' width='3%'><img src='img/buscar.gif' class='imgexpandeinfo' alt='Administrar Cliente' onClick=""window.location.href = '"&URL&"lc/homologa/adm/frmEditCadastroClienteLc.asp?showclient=true&idcliente="&arrClientes(0,i)&"';""/></td>"				
				...
				Else
					Response.Write "<tr>" 				
					Response.Write "<td class='classColorRelImpar' align='center' width='3%'><img src='img/buscar.gif' class='imgexpandeinfo' alt='Administrar Cliente' onClick=""window.location.href = '"&URL&"lc/homologa/adm/frmEditCadastroClienteLc.asp?showclient=true&idcliente="&arrClientes(0,i)&"';""/></td>"				
