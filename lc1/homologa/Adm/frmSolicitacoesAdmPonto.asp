		...
		With Response	
			If intSolColeta > -1 Then
				...
				For i = (intProdsPorPag * (intPag - 1)) to intUltima
					If i Mod 2 = 0 Then
						.Write "<tr>"
						.Write "<td width='1%' align='left' class='classColorRelPar'><img class='imgexpandeinfo' src='img/buscar.gif' alt='Verificar Solicitação de Coleta' onClick=""javascript:window.open('frmEditSolicitacaoColetaPontoColetaAdm.asp?iscoletadomiciliar="&arrSolColeta(8,i)&"&idsolic="&arrSolColeta(0,i)&"&tipopessoa="&arrSolColeta(11,i)&"','','width=500,height=650,scrollbars=no,status=no,location=no,toolbar=no,menubar=no');"" ></td>"
					...
					Else
						.Write "<tr>"
						.Write "<td width='1%' align='left' class='classColorRelImpar'><img class='imgexpandeinfo' src='img/buscar.gif' alt='Verificar Solicitação de Coleta' onClick=""javascript:window.open('frmEditSolicitacaoColetaPontoColetaAdm.asp?iscoletadomiciliar="&arrSolColeta(8,i)&"&idsolic="&arrSolColeta(0,i)&"&tipopessoa="&arrSolColeta(11,i)&"','','width=500,height=650,scrollbars=no,status=no,location=no,toolbar=no,menubar=no');"" ></td>"
