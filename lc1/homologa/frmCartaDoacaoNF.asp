...
<p>
  ...
  **Peso aproximado total, considerando 0,3Kg por cartucho inservível.
<p>
	...
	<%if lTipoColeta = 1 then%>
		...
		<tr> 
		  <td width="300" valign="top">Okidata do Brasil Informatica Ltda<br />
		    ...
		    N&ordm; 100 / 5º andar / bloco C<br />
		    Cidade: São Paulo<br />
		    Estado: SP<br />
		  ...
		  <!--  Atlas Logística Ltda.<br />
		    Endereço: Avenida Aruanã 884<br />
		    Comp.: <br />
		    Cidade: Barueri<br />
		    Estado: SP<br />
		    CNPJ: 00.493.606/0001-06<br />
		    I.E: 206.076.757.110</td>    -- ANDRE AGGIO 22/06/2015 ALTERADO PARA OPERAÇÃO RESOLUTION -->
		    RESOLUTION ECOLOGÍSTICA REVERSA LTDA.<br />
		    Endereço: Rua Marina Ciufuli Zanfelice, 280<br />
		    Comp.: <br />
		    Cidade: São Paulo<br />
		    Estado: SP<br />
