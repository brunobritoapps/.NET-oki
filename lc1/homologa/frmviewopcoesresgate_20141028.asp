...
'						html = html & "</tr>"
            ...
            'response.write getSaldoByCliente & "<br />"
		else
			getSaldoByCliente = saldoTotal
            'response.write getSaldoByCliente & "<br />não achou nada<br />"
		end if
	...
	Function getSaldoByClienteNew(lTotPontosGastos)
		...
		sql = "select distinct(bonus.numero_solicitacao) " & _
					...
					"left join clientes as cli " & _
					"on bonus.clientes_idclientes = cli.idclientes " & _
					"where bonus.clientes_idclientes in (select idclientes from clientes where cod_cli_consolidador = "&session("IDCliente")&" or idclientes = "&session("IDCliente")&") and saldo > 0"
...
<div id="container">
	<div id="conteudo" style="height:100%;">
        ...
        <table cellspacing="0" cellpadding="0" width="775" id="tableEditSolicitacaoColetaAdm" border="0">
			<tr>
				<td id="explaintitle" colspan="3" align="center">&nbsp;</td>
			</tr>
			<tr>
				<td id="explaintitle" colspan="3" align="center">Visualizar Opções de Resgate</td>
			</tr>
			<tr>
				<td id="explaintitle" colspan="3" align="center">&nbsp;</td>
			</tr>
			<tr>
				<td id="explaintitle" colspan="3" align="center">ATENÇÃO: Após a escolha dos itens da lista e a quantidade, clique no botão Resgatar no final da página.<br>Para adicionar produtos digite a quantidade e em seguida clique no ícone carrinho.<br />
                    Para excluir a quantidade, digite 0 (zero), e em seguida clique no ícone carrinho.</td>
			</tr>
			<tr>
				<td colspan="3" align="right"><a class="linkOperacional" href="frmoperacionalcliente.asp">&laquo Voltar</a></td>
			</tr>
			<tr>
				<td style="text-align:right;">
					Procurar:</td>
				<td class="auto-style1">
                    <INPUT type="text" id=txtSearch name=txtSearch class="textreadonly"></td>
				<td>
					&nbsp;<input type="submit" class="btnform" name="action1" value="Procurar"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</td>
			</tr>
			<tr>
				<td colspan="4">
					Obs: para listar TODOS os ítens deixe o campo em branco e clique no botão Procurar</td>
				<td>
					&nbsp;</td>
			</tr>
            ...
            <tr>
                <td colspan="4" style="text-align: right;">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<b>Saldo do bônus:</b>&nbsp;<input type="text" name="saldo" value="<=saldoTotalBonus%>" disabled="disabled" style="text-decoration-color: #000000;"/>
                    </div>
                    <div align="center"><a href="#" class="linkOperacional"><= request.querystring("msg") %></a></div></div>
                 </td>
            </tr>
            -->
        ...
        <table cellspacing="0" cellpadding="0" width="775" id="tableEditSolicitacaoColetaAdm" border="0">
			<tr id="trnumsolcoleta">
				<td>
					...
					<end if%>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<b>Saldo do bônus:</b>&nbsp;<input type="text" name="saldo" value="<%=saldoTotalBonus%>" class="text" disabled="disabled" style="text-decoration-color: #000000;"/>
                    </div>-->
            <tr>
                <td colspan="4" style="text-align: right;">
                    <div id="explaintitle" align="right" style="padding:2px 2px 2px 2px;">
