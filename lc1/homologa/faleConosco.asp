...
<%
	...
	Sub EnviarEmailOki()
		...
		'	EnviarMail.To = "sustentabilidadeoki@sustentabilidadeoki.com.br"
		...
		'Else
			...
			objCDOSYSMail.To = "elaine.nascimento@okidata.com"
                    ...
                    <td valign="top"> <div align="justify">
                        ...
                        <table width="480" border="0" cellpadding="2" cellspacing="2" class="fonteMenu">
                          ...
                          <tr>
                            ...
                            <td><input name="textfield3" type="text" class="TextBox" width="200"/></td>
                          ...
                          <tr>
                            ...
                            <td><input name="textfield32" type="text" class="TextBox" width="200" /></td>
                          ...
                          <tr>
                            ...
                            <td><input name="textfield33" type="text" class="TextBox" width="100" /></td>
                          ...
                          <tr>
                            ...
                            <td><input name="textfield34" type="text" class="TextBox" width="200" /></td>
                          ...
                          <tr>
                            ...
                            <td height="50"><div align="center" style="text-align: left">Em caso de dúvidas ou
                                sugestões, entre em contato:<br />
                                (11) 3444-3563 / (11) 3444-3500 - PABX<br>

                                Horário de atendimento: Segunda a Quinta

                                - das 8:00 &agrave;s 18:00.<br />
                                Sexta - das 8:00 às 17:00</div></td>
