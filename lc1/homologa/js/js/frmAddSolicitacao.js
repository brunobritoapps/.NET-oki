...
*/
	...
	function loadClear() {
		...
		form.txtMunicipioColeta.value = "";
		form.txtEstadoColeta.value = "";	
		form.txtContatoRespColeta.value = "";
		form.txtDDDContatoRespColeta.value = "";
		form.txtTelefoneContatoRespColeta.value = "";
		
		document.getElementByid('txtContatoRespColeta').readOnly = true;
		document.getElementById('txtLogradouroColeta').readOnly = true;
		document.getElementById('txtCepColeta').readOnly = true;
		document.getElementById('txtCompLogradouroColeta').readOnly = true;
		document.getElementById('txtNumeroColeta').readOnly = true;
		document.getElementById('txtBairroColeta').readOnly = true;
		document.getElementById('txtMunicipioColeta').readOnly = true;
		document.getElementById('txtEstadoColeta').readOnly = true;
		document.getElementById('txtContatoRespColeta').readOnly = true;
		document.getElementById('txtDDDContatoRespColeta').readOnly = true;
		document.getElementById('txtTelefoneContatoRespColeta').readOnly = true;
		document.getElementById('txtRamalContatoRespColeta').readOnly = true;
		document.getElementById('txtDepContatoRespColeta').readOnly = true;
